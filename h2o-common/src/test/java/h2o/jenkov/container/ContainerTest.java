...
import h2o.jenkov.container.java.JavaFactoryBuilder;
...
public class ContainerTest extends TestCase {
    ...
    public void testReplaceScriptFactory(){
        ...
        builder.addFactory("test  = * h2o.jenkov.container.TestProduct().setValue1('value1'); ");
        ...
        builder.replaceFactory("test = * h2o.jenkov.container.TestProduct().setValue1('value2'); ");
    ...
    public void testInit() {
        ...
        String factoryDefinition =
                "singletonFactory = 1 h2o.jenkov.container.SingletonTestProduct(); " +
                "   config { h2o.jenkov.container.SingletonTestProduct.doInit(); } ";
