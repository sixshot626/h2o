...
import h2o.jenkov.container.impl.factory.*;
...
public class ScriptFactoryBuilder2Test extends TestCase {
    ...
    public void testUnknownFactories(){
        ...
        builder.addFactory("decimal1 = h2o.jenkov.container.TestProduct().setDecimal(1.55); ");

        try{
            builder.addFactory("decimal2 = h2o.jenkov.container.TestProduct(decimal).setDecimal(1.55); ");
    ...
    public void testDoubleValues(){
        Container container = new Container();
        ScriptFactoryBuilder builder = new ScriptFactoryBuilder(container);
        builder.addFactory("decimal = h2o.jenkov.container.TestProduct().setDecimal(1.55); ");
    ...
    public void testFactoryAssignment(){
        ...
        builder.addFactory("bean = h2o.jenkov.container.TestProduct.staticInt = 5;");
        Object bean = container.instance("bean");
        assertEquals(5, TestProduct.staticInt);

        builder.addFactory("bean2 = h2o.jenkov.container.TestProduct(); " +
    ...
    public void testClassInjection(){
        ...
        builder.addFactory("bean = * h2o.jenkov.container.TestProduct.class;");
    ...
    public void testNullInjection() {
        ...
        builder.addFactory("bean1 = h2o.jenkov.container.TestProduct().setValues(\"null\", \"null\"); ");
    ...
    public void testNullInjection2(){
        Container container = new Container();
        ScriptFactoryBuilder builder = new ScriptFactoryBuilder(container);
        builder.addFactory("bean1 = h2o.jenkov.container.TestProduct((h2o.jenkov.container.TestProduct) null).setValues(1, (java.lang.String) 2); " +
    ...
    public void testCasting(){
        String script = "test = * h2o.jenkov.container.TestProduct();" +
    ...
    public void testLocalProducts(){
        String script = "test = * h2o.jenkov.container.script.SomeFactoryProduct($0);" +
    ...
    public void testBuildConstructorFactory(){
        ...
        builder.addFactory("test = * h2o.jenkov.container.TestProduct();");
        GlobalFactoryProxy factory = (GlobalFactoryProxy) container.getFactory("test");
        assertTrue(factory.getDelegateFactory() instanceof GlobalNewInstanceFactory);
        GlobalNewInstanceFactory configuringFactory = (GlobalNewInstanceFactory) factory.getDelegateFactory();
        assertTrue(configuringFactory.getLocalInstantiationFactory() instanceof LocalProductProducerFactory);
        ...
        builder.addFactory("test2 = * h2o.jenkov.container.TestProduct(h2o.jenkov.container.TestProduct());");
