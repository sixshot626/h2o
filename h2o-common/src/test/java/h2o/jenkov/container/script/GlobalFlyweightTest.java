...
public class GlobalFlyweightTest extends TestCase {
    ...
    public void testInstance(){
        ...
        builder.addFactory("bean = 1F h2o.jenkov.container.TestProduct();");
        ...
        builder.addFactory(
                "bean2 = 1F h2o.jenkov.container.TestProduct();  " +
        ...
        builder.addFactory(
                "bean3 = 1F h2o.jenkov.container.TestProduct();  " +
        ...
        builder.addFactory(
                "bean4 = 1F h2o.jenkov.container.TestProduct();  " +
