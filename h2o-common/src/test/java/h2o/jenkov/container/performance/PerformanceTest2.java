package h2o.jenkov.container.performance;
...
public class PerformanceTest2 {
    ...
    private static void writeLargeFile(int iterations, String fileName) throws IOException {
        ...
        output.write("factoryNameWhichIsQuiteLong = * h2o.jenkov.container.TestProduct();".getBytes());

        for(int i=0; i<iterations; i++){
            output.write(("i" + i + " = * factoryNameWhichIsQuiteLong;").getBytes());
//            output.write(("i" + i + " = * h2o.jenkov.container.TestProduct();").getBytes());
