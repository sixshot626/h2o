...
/**
 * A special {@link Thread} that provides fast access to {@link io.netty.util.concurrent.FastThreadLocal} variables.
 */
public class FastThreadLocalThread extends Thread {
    ...
    /**
     * Returns {@code true} if {@link io.netty.util.concurrent.FastThreadLocal#removeAll()} will be called once {@link #run()} completes.
     */
