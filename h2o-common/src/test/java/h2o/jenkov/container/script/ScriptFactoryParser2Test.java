...
public class ScriptFactoryParser2Test extends TestCase {
    ...
    public void testParseNameWithPeriod() {
        String inputString = "/myApp/subDir/myAction.html = * h2o.jenkov.container.script.SomeFactoryProduct($0);";
        ParserInput input = parserInput(inputString);
    ...
    public void testParseMode(){
        String inputString = "test3 = * h2o.jenkov.container.TestProduct.createProduct(test).getInternalProduct();";
        ParserInput input = parserInput(inputString);
    ...
    public void testParseInputParameters() {
        String inputString = "name = * h2o.jenkov.container.script.SomeFactoryProduct($0);";
        ParserInput input = parserInput(inputString);
    ...
    public void testParseFactory() throws IOException {
        String inputString =
                "name = * h2o.jenkov.container.script.SomeFactoryProduct(other, someOther);" +
        ...
        FactoryDefinition definition = parser.parseFactory(input);
        assertEquals("name", definition.getName());
        assertEquals("h2o.jenkov.container.script.SomeFactoryProduct", definition.getIdentifierOwnerClass());
...
//        assertEquals("name", definition.getDisposeFactory().getIdentifierTargetFactory().getIdentifier());
    ...
    public void testParseConfigFactoryChains() throws IOException {
        String inputString = "smtp.setName(); \n" +
                             "h2o.jenkov.container.TestProduct.config(smtp); }";
        ...
        assertEquals("h2o.jenkov.container.TestProduct", definition2.getIdentifierOwnerClass());
    ...
    public void testParseFactoryChainList() throws IOException {
        String expectedClassName = "h2o.jenkov.container.script.SomeFactoryProduct";
        String inputString       = "h2o.jenkov.container.TestProduct, " +
                                   "h2o.jenkov.container.script.SomeFactoryProduct()," +
                                   "someId)";
        ...
        FactoryDefinition definition1 = definitions.get(0);
        assertEquals("h2o.jenkov.container.TestProduct", definition1.getIdentifier());

        FactoryDefinition definition2 = definitions.get(1);
        assertEquals("h2o.jenkov.container.script.SomeFactoryProduct", definition2.getIdentifierOwnerClass());
    ...
    public void testParseFactoryChain() throws Exception {
        ...
        inputString = "h2o.jenkov.container.script.SomeFactoryProduct.CONSTANT.method().OTHER.otherMethod();";
        ParserInput input      = parserInput(inputString);
        ...
        inputString = "h2o.jenkov.container.script.SomeFactoryProduct;";
        input      = parserInput(inputString);
    ...
    public void testParseHeadFactory() throws IOException {
        ...
        inputString = "h2o.jenkov.container.script.SomeFactoryProduct(other, someOther);";
        input       = parserInput(inputString);
        ...
        inputString = "h2o.jenkov.container.script.SomeFactoryProduct.CONSTANT;";
        input       = parserInput(inputString);
        definition  = parser.parseHeadFactory(input, null);
        assertNotNull(definition);
        assertEquals(expectedClassName, definition.getIdentifierOwnerClass());
        ...
        inputString = "h2o.jenkov.container.script.SomeFactoryProduct.CONSTANT.method()";
        input       = parserInput(inputString);
        definition  = parser.parseHeadFactory(input, null);
        assertNotNull(definition);
        assertEquals(expectedClassName, definition.getIdentifierOwnerClass());
        ...
        inputString = "h2o.jenkov.container.script.SomeFactoryProduct.method()";
        input       = parserInput(inputString);
        definition  = parser.parseHeadFactory(input, null);
        assertNotNull(definition);
        assertEquals(expectedClassName, definition.getIdentifierOwnerClass());
    ...
    public void testParseClass() throws IOException{
        ...
        ParserInput input = parserInput("h2o.jenkov.Fun");

        className = parser.parseClass(input);
        assertNull(className);
        assertEquals(new Token("h2o"), input.nextToken());

        String inputString       = "h2o.jenkov.container.script.SomeFactoryProduct";
        String expectedClassName = "h2o.jenkov.container.script.SomeFactoryProduct";
        input = parserInput(inputString);
        className = parser.parseClass(input);
