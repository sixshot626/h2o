...
public class MethodFactoryTest extends TestCase {
    ...
    public void testMethodModifiers(){
        ...
        try {
            builder.addFactory("test = * h2o.jenkov.container.TestProduct().createProduct();");
        ...
        try {
            builder.addFactory("test = * h2o.jenkov.container.TestProduct.getValue1();");
            fail("The createProduct() method is static and trying to call it on an instance should throw exception");
        } catch (ParserException e) {
            if(!"FactoryBuilder".equals(e.getInfoItems().get(0).errorContext)){
                fail("Wrong exception caught");
    ...
    public void testBuildMethodFactory() {
        ...
        builder.addFactory("test2 = * h2o.jenkov.container.TestProduct.createProduct(test);");
        ...
        builder.addFactory("test3 = * h2o.jenkov.container.TestProduct.createProduct(test).getInternalProduct();");
