 ...
 */
package h2o.apache.commons.lang;

import h2o.apache.commons.lang.reflect.MethodUtils;
...
public class ObjectUtils {
     ...
     * @throws UnhandledException if the object is cloneable and the clone operation fails
     * @since 2.6
     */
        ...
        if (o instanceof Cloneable) {
            ...
            if (o.getClass().isArray()) {
                ...
                try {
                    ...
                    throw new UnhandledException("Cloneable type "
                        + o.getClass().getName()
                        + " has no clone method", e);
                } catch (final IllegalAccessException e) {
                    throw new UnhandledException("Cannot clone Cloneable type "
                        + o.getClass().getName(), e);
                } catch (final InvocationTargetException e) {
                    throw new UnhandledException("Exception cloning Cloneable type "
